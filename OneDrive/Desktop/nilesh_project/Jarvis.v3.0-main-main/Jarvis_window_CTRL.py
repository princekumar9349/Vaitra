...
APP_MAPPINGS = {
    ...
    "paint": "mspaint",
    "vs code": os.path.join(os.environ["USERPROFILE"], "AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"),
    "postman": os.path.join(os.environ["USERPROFILE"], "AppData\\Local\\Postman\\Postman.exe")
}
